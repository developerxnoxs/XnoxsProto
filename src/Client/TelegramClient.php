...
class TelegramClient
{
    ...
    public function downloadDocument(
        ...
        return $this->downloader->downloadDocument($docId, $accessHash, $fileRef, $savePath, $onProgress);
    }
    ...
    public function downloadPhoto(
        ...
        return $this->downloader->downloadPhoto($photoId, $accessHash, $fileRef, $savePath, $onProgress, $thumbSize);
    }
